...
public static void main(String[] args) {
	...
	//한 번에 여러개를 선언하는 것도 가능
	//초기화도 됨
	
	float f1 = 2.1f ,f2 = 3.5f;
	...
	//내용물을 임시로 담아높을 컵이 필요하다.
	int temp = su1; //temp에 su1(20) 들어감
	su1 = su2; // su1에 su2(30) 들어감
	su2 = temp; // su2에 temp(20) 들어감
